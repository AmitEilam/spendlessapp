...
function Stat({ value, type, category }) {
  ...
  return (
    <div className='flex flex-col bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 m-6 w-[230px] my-4 border border-gray-200 dark:border-gray-700 inner-border-left transition-transform transform fade-in'>
